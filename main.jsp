...
<html>
	...
	<body>
		<div id="header-title">
			...
			ID : <input type="text" name="user-id"> PW : <input type="password" name="user-pw">
			<input type="button" value="SIGN IN" onclick="signInClick()">
		...
		<div class="setDiv">
		    ...
		    <h3>SIGN UP</h3>
		               <form method="post" action="">
		                       <table border="1" width="400" height="400">
		                              ...
		                              <tr>
		                                      ...
		                                      <td>
		                                             ...
		                                             <label name="yes" for="ag2">No</label>
		                                      </td>
		                              </tr>
		                              <tr>
		                     ...
		                     <br />
		                     <input type="button" value="Sign In" onclick="formCheck()" />
