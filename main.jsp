...
<html>
	...
	<body>
		<div id="header-title">
			...
			<form method="post" action="main_member.jsp">
		...
		<div class="setDiv">
		    ...
		    <div class="window">
		    <h3>SIGN UP</h3>
		               <form method="post" action="member_mypage.jsp">
		                       <table border="1" width="400" height="400">
		                              
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">ID</td>
		                                      <td><a href="http://localhost:8080/member_id_check.jsp" target="_new"><input type="text" id="user_id" name="user_id"/>
		                                      <input type="button" value="CHECK"   /></a>
		                                      </td>                                
		                              </tr>
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">PASSWORD</td>
		                                      <td><input type="password" id="password" name="password"/></td>
		                              </tr>
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">PASSWORD CHECK</td>
		                                      <td><input type="password" id="password_check"/></td>
		                              </tr>
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">NAME</td>
		                                      <td><input type="text" id="user_name" name ="user_name" /></td>
		                              </tr>
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">BIRTH</td>
		                               ...
		                               <tr>
		                                      <td align="center" bgcolor="#FFFFCC">phone</td>
		                                      <td>
		                                      ...
		                                      -<input type="text" id="hp2" name="hp2" maxlength="4" size="4" />
		                                      -<input type="text" id="hp3" name="hp3" maxlength="4" size="4" />
		                                      </td>
		                              </tr>
		                              
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">mailing</td>
		                                      <td>
		                              ...
		                              <tr>
		                                      <td align="center" bgcolor="#FFFFCC">Terms and Conditions</td>
		                                      <td>
